...
CREATE TABLE `equipment` (
  ...
  `storedQuantity` smallint DEFAULT NULL,
  `distQuantity` smallint DEFAULT NULL,
  `sportID` smallint DEFAULT NULL,
  `isApparel` tinyint(1) DEFAULT NULL,
...
-- Dump completed on 2024-01-29 21:28:53
